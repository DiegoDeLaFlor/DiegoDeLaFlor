...
| **Tech Stack** | `MCP` `LangChain` `OpenAI API` `Python` `Jira API` `Confluence API` `Figma API` `Google Cloud` `Cypress` `RAG`                                                                                                                                                                                      |
...
| Dimension      | Details                                                                                                                                                                                                                                                                |
| -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Challenge**  | Monolithic Laravel application prevented independent deployments, created tight coupling between features, and slowed time-to-market for new modules. Scaling was coupled; refactoring was risky.                                                                      |
| **Solution**   | Architected a **domain-driven design (DDD)** migration to microservices on Azure. Modeled bounded contexts (Booking, Payments, Notifications, Analytics), deployed as independent services with async messaging. Implemented event-driven patterns for loose coupling. |
| **Tech Stack** | `Azure` `Domain-Driven Design (DDD)` `Microservices` `NestJS` `RabbitMQ` `Docker` `Kubernetes` `SQL Server` `CI/CD`                                                                                                                                                    |
...
| **Tech Stack** | `Python` `Anthropic API` `AST Parsing` `LLM Chains` `Click CLI`                                                                                                                                                                           |
